...
public class InputManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        capmanRight = new Vector3(-12.0f, 13.0f, 0.0f);
        capmanUp = new Vector3(-12.0f, 9.0f, 0.0f);
        capmanLeft = new Vector3(-7.0f, 9.0f, 0.0f);
        capmanDown = new Vector3(-7.0f, 13.0f, 0.0f);
    }
    ...
    void Update()
    {
        ...
        {
            tweener.AddTween(item.transform, item.transform.position, new Vector3 (-7.0f, 13.0f, 0.0f), 2.0f);
		}
        ...
        {
            tweener.AddTween(item.transform, item.transform.position, new Vector3 (-12.0f, 9.0f, 0.0f), 2.0f);
		}
